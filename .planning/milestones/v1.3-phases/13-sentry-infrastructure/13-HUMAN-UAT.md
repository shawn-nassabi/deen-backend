...
result: pass
note: "Header confirmed on /health. Sentry correlation_id tag not yet visible — expected, bind_sentry_scope wired in Phase 14+. Sentry trace ID present as alternative."
