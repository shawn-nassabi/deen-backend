...
## phase-5 async-fiqh-and-routes (DEE-44) — 2026-05-26T03:08:55+00:00

- mode: `in-process`
- n: 10
- wall_clock_s: **0.8339**
- p50_s / p95_s: 0.8256 / 0.8334
- throughput_rps: 11.9912
- speedup_vs_serial: **8.9934**
...
```json
{
  ...
  "throughput_rps": 11.9912,
  "speedup_vs_serial": 8.9934,
  "timestamp": "2026-05-26T03:08:55+00:00"
}
```

## phase-5 async-fiqh-and-routes (DEE-44) — 2026-05-26T03:13:13+00:00

- mode: `in-process`
- n: 10
- wall_clock_s: **0.8721**
- p50_s / p95_s: 0.8556 / 0.8686
- throughput_rps: 11.466
- speedup_vs_serial: **8.5995**
...
```json
{
  ...
  "throughput_rps": 11.466,
  "speedup_vs_serial": 8.5995,
  "timestamp": "2026-05-26T03:13:13+00:00"
}
```
